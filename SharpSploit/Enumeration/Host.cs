...
namespace SharpSploit.Enumeration
{
    ...
    public class Host
    {
        ...
        /// <returns></returns>
        public static bool IsX64Process(Process process)
        {
            bool retVal = false;
            ...
            //Are we currently in a 32-bit process on a 64-bit machine?
                ...
                Execution.DynamicInvoke.Win32.IsWow64Process(System.Diagnostics.Process.GetCurrentProcess().Handle, ref x64);
