...
namespace SharpSploit.Execution.Injection
{
    ...
    /// </summary>
    public class SectionMapAllocationTechnique : AllocationTechnique
    {
        ...
        /// Default constructor.
        /// </summary>
        public SectionMapAllocationTechnique()
        {
        ...
        /// </summary>
        public SectionMapAllocationTechnique(uint localPerms = Win32.WinNT.PAGE_EXECUTE_READWRITE, uint remotePerms = Win32.WinNT.PAGE_EXECUTE_READWRITE, uint atts = Win32.WinNT.SEC_COMMIT)
        {
            DefineSupportedPayloadTypes();
