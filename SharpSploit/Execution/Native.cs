...
namespace SharpSploit.Execution
{
    ...
    public static class Native
    {
        ...
        //Borrowed from: https://doxygen.reactos.org/db/dc9/nt__native_8h_source.html
        [StructLayout(LayoutKind.Sequential)]
        public struct FLOATING_SAVE_AREA
        {
            ...
            ulong DataOffset;
            ulong DataSelector;
            byte[] RegisterArea; //SIZE_OF_80387_REGISTERS = 80
            ulong Cr0NpxState;
        }

        //Reversed from several different sources, so may be wrong
        //Used only by NtCreateThread and not other stack context APIs.
        [StructLayout(LayoutKind.Sequential)]
        ...
        //Used only by NtCreateThread and not other thread context APIs. Borrowed from: https://doxygen.reactos.org/db/dc9/nt__native_8h_source.html
        [StructLayout(LayoutKind.Sequential)]
